          ...
          <div class="columns">
            <div class="column">
              <h2 class="is-size-0-desktop is-size-2-touch has-text-weight-light">
                @if (App::isLocale('en'))
                  <h1 class="is-size-0-desktop is-size-2-touch has-text-weight-light">{{ $vacancy->name }}</h1>
                @else
                  <h1 class="is-size-0-desktop is-size-2-touch has-text-weight-light">{{ $vacancy->name_es }}</h1>
                @endif
              </h2>
