...
<head>
  ...
  */
  #templateHeader{
    /*editable*/ background-color:#4a4a4a;
  ...
  */
  .templateButton{
    ...
    /*editable*/ background-color:#ff7900;
    /*editable*/ border:0;
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                  <tr>
                    <td class="headerContent">
                      ...
                      <img src="https://website-c230-consultores.nyc3.digitaloceanspaces.com/website_images/logo_light.png" style="max-width:200px; padding:2rem;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                        ...
                        <tr>
                          <td valign="top" class="bodyContent">
                            <div mc:edit="std_content00">
                              <h1 class="h1">New application to {{ $application->vacancy->name }} has been posted successfully</h1>
                              To review the applicant's information, please access the application area.
                            </div>
                          </td>
                        </tr>
                        <tr>
                              ...
                              <tr>
                                <td valign="middle" class="templateButtonContent">
                                  <div mc:edit="std_content02">
                                    <a href="http://c-230.com" target="_blank">Go to applications</a>
                                  </div>
                                </td>
                              </tr>
                            </table>
